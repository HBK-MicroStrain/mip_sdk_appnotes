...
// Which edge will trigger message output: Rising, falling, or both
constexpr mip::commands_3dm::GpioConfig::Behavior PIN_EDGE = mip::commands_3dm::GpioConfig::Behavior::TIMESTAMP_RISING;
//constexpr mip::commands_3dm::GpioConfig::Behavior PIN_EDGE = mip::commands_3dm::GpioConfig::Behavior::TIMESTAMP_FALLING;
//constexpr mip::commands_3dm::GpioConfig::Behavior PIN_EDGE = mip::commands_3dm::GpioConfig::Behavior::TIMESTAMP_EITHER;
...
int demo(mip::Interface& device)
{
    ...
    gpio.pin      = GPIO_PIN;
    gpio.feature  = mip::commands_3dm::GpioConfig::Feature::TIMESTAMP;
    gpio.pin_mode = PIN_MODE;
    gpio.behavior = PIN_EDGE;
    ...
    // Use the "EDGE" mode because the pin is configured for timestamping.
    trigger.parameters.gpio.mode = mip::commands_3dm::EventTrigger::GpioParams::Mode::EDGE;

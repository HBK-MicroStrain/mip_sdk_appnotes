...
int main()
{
    ...
    MICROSTRAIN_LOG_INIT(log_callback, MICROSTRAIN_LOG_LEVEL_TRACE, nullptr);
    ...
    // Configure the pin to GPIO OUTPUT_LOW.
    ...
    result = mip::commands_3dm::writeGpioConfig(
        ...
        /* Behavior */ mip::commands_3dm::GpioConfig::Behavior::GPIO_OUTPUT_LOW,
        /* Mode     */ mip::commands_3dm::GpioConfig::PinMode::NONE
    );
    ...
    // It would also be perfectly fine to use mip::commands_3dm::writeEventAction, etc. instead.

    mip::commands_3dm::EventAction action;
    action.function = mip::FunctionSelector::WRITE;
    action.instance = ACTION_ID;
    action.trigger  = TRIGGER_ID;
    action.type     = mip::commands_3dm::EventAction::Type::GPIO;
    action.parameters.gpio.pin  = LOGICAL_GPIO_PIN;
